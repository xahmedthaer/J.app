...
import { 
    ...
    Pencil, Users, Bell, CircleHelp, Headset as LucideHeadset, LogOut, UserPlus, Shield, FileText, 
    ...
    Calculator, RotateCcw, Landmark, Menu, LayoutDashboard, Rocket
} from 'lucide-react';
...
export const CalculatorIcon: React.FC<IconProps> = ({ className }) => (
    <Calculator className={className} strokeWidth={1.5} />
);
...
export const SupportIcon: React.FC<IconProps> = ({ className }) => (
    <LucideHeadset className={className} />
);
