...
import { HomeIcon, BagIcon, UserIcon, CalculatorIcon } from './icons';

type MainView = 'products' | 'orders' | 'account' | 'financial';

interface BottomNavProps {
  activeView: MainView;
  setActiveView: (view: MainView) => void;
  unreadTicketsCount?: number; // Kept as optional for compatibility, but unused
}
