...
import { ChevronLeftIcon, CopyIcon, AvatarIcon, XMarkIcon, ClipboardListIcon, ChartUpIcon, UsersIcon, MoneyBillTransferIcon } from './icons';
import { HeaderConfig } from '../App';

const CheckIcon: React.FC<{className?: string}> = ({className}) => <i className={`fa-solid fa-check ${className}`}></i>;
